<?php if(!class_exists('raintpl')){exit;}?><?php $tpl = new RainTPL;$tpl_dir_temp = self::$tpl_dir;$tpl->assign( $this->var );$tpl->draw( dirname("header") . ( substr("header",-1,1) != "/" ? "/" : "" ) . basename("header") );?>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/home/carousel-header/foto017.png" alt="Image">
                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    <p
                                        ...
                                        BIENVENIDO</p>
                                    <!-- <h1 class="display-4 mb-4 animated slideInDown" translate="no">El primer laboratorio de suplementación nutricional del austro del país
                                    </h1> -->
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/home/carousel-header/foto018.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    ...
                                    <!-- <h1 class="display-4 mb-4 animated slideInDown">Nuestro éxito es tu Salud </h1> -->
                                    <!--<a href="" class="btn btn-primary py-3 px-5 animated slideInDown">Leer Más</a>-->
                                </div>
                            </div>
                        </div>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/home/carousel-header/foto019.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/home/carousel-header/foto020.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/home/carousel-header/foto021.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/home/carousel-header/foto022.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/home/carousel-header/foto023.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid rounded" src="img/home/productos/foto001.png">
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4" align="justify">Nuestros suplementos no solo destacan por su calidad, sino también por su presentación práctica y conveniente. Cada producto está diseñado para facilitar su uso diario, con envases modernos y funcionales que garantizan su conservación óptima y facilidad de transporte.
                    </p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="display-5 mb-4">Descubre más con nuestro video</h1>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="videoModalLabel">Video Promocional</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="ratio ratio-16x9">
                        <video controls>
                            <source src="img/home/videos/bella.mp4" type="video/mp4">
