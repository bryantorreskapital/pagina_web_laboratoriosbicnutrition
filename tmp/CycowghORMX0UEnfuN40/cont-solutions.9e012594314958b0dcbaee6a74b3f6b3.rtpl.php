                    ...
                    <div class="tab-content w-100">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-comercial" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="img/kapital-clinicas.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-clinicas" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="img/kapital-produccion.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-produccion" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-4">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="img/kapital-restaurantes.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-restaurantes" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-5">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="img/kapital-transporte.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-transporte" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>                                
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-6">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="img/kapital-talleres.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-talleres" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-7">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="img/kapital-veterinarias.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-veterinarias" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-8">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="img/kapital-funerarias.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <a href="index.php?page=pagemodulos&cont=modulo-funerarias" class="btn btn-primary py-3 px-5 mt-3">Leer Más</a>
                                </div>
                            </div>
                        </div>
                    </div>
